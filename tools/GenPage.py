...
#### For ####:
# Generate pages for a PDF repository
# Generate json for folder PDF informations
# Generate fake PDF files based on pdf-info json
# Move PDF to ISSN/Volume/Issue directory based on crossref information
...
if __name__ == "__main__":
	helpdes='''GenPage Tool for OADPF project'''
	...
	parser.add_option('-f', "--force", action="store_true", 
					...
					help="Force to rewrite the page")
	parser.add_option('-c',"--combine", action="store", 
	...
	parser.add_option("--move", action="store_true", 
					...
					help="Just move the pdf to prefix folder. ")
